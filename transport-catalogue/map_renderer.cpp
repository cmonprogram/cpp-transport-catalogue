...
void renderer::MapRenderer::SetSettings(renderer::RenderSettings settings) {
	settings_ = settings;
}

renderer::RenderSettings& renderer::MapRenderer::GetSettings() {
	return settings_;
}


void renderer::MapRenderer::FormMap(std::deque<catalogue::parse_structs::Bus> bus_list, std::ostream& out) const
{
